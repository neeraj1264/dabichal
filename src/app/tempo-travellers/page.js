  ...
  const cars = [
    {
      ...
      img: "/tempo/t1.jpg",
      to: "/tempo-travellers/12-seater-tempo-traveller/",
    },
    {
      name: "17 Seater Tempo Traveller",
      img: "/tempo/t2.jpg",
      to: "/tempo-travellers/17-seater-tempo-traveller/",
    },
    {
      name: "12 Seater Urbania Traveller",
      img: "/tempo/t3.jpg",
      to: "/tempo-travellers/12-seater-urbania-traveller/",
    },
    {
      name: "17 Seater Urbania Traveller",
      img: "/tempo/t4.jpg",
      to: "/tempo-travellers/17-seater-urbania-traveller/",
    },
  ];
             ...
             transform hover:-translate-y-3"
              >
                ...
                <Reveal className="pt-2 sm:p-4 text-center">
                  ...
                  <Link
                    className="text-xs sm:text-lg group inline-flex items-center gap-2 bg-orange text-white px-5 py-2 rounded-full font-medium transition-all duration-300 hover:bg-white hover:text-orange border-2 border-orange"
                    href={car.to}
                  >
                    Book Now
