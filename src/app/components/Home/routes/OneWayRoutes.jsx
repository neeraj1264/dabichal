...
export const OneWayRoutes = () => {
  ...
  return (
    <div className="bg-[#1c1e22] pt-24 pb-8">
      <h2 className="text-center text-white text-2xl sm:text-3xl font-bold mb-8">
        One-Way Routes
      </h2>
        ...
        {routes.map((route, idx) => (
          ...
          >
            ...
            />
                      ...
                      {/* Orange Floating Box */}
            <div className="absolute bottom-14 left-1/2 transform -translate-x-1/2 bg-[#f58220] w-[85%] rounded-b-xl pb-4 pt-2 px-2 flex flex-col items-center text-white shadow-lg">
