      ...
      <div className="max-w-7xl mx-auto px-20 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <Reveal className="text-left">
          ...
          <ul className="space-y-2 text-base text-paragraph">
            ...
            <li>
              <Link href="/taxi-ride">Taxi Ride</Link>
            </li>
            <li>
              <Link href="tempo-travellers">Force Travellers</Link>
            </li>
            <li>
              <Link href="/himachal-pilgrim"> Himachal/Pilgrim </Link>
            </li>
            <li>
              <Link href="/ladakh-kashmir">Ladakh/Kashmir</Link>
            </li>
            <li>
              <Link href="/outstation-routes"> Outstation Routes </Link>{" "}
            </li>
            <li>
        ...
        <Reveal className="text-left">
          ...
          <ul className="space-y-2 text-base text-paragraph">
            <li>
              <Link href="/taxi-ride/innova-hycross"> Innova Hycross </Link>
            </li>
            <li>
              <Link href="/taxi-ride/honda-amaze">Honda Amaze </Link>
            </li>
            <li>
              <Link href="/taxi-ride/toyota-etios">Toyota Etios </Link>
            </li>
            <li>
              <Link href="/taxi-ride/innova-crysta">Innova Crysta </Link>
            </li>
            <li>
              <Link href="/taxi-ride/maruti-dzire">Maruti Dzire </Link>
            </li>
            <li>
              <Link href="/taxi-ride/maruti-ertiga">Maruti Ertiga </Link>
            </li>
            <li>
              <Link href="/taxi-ride/kia-carens">Kia Carens </Link>
            </li>
          </ul>
        </Reveal>
